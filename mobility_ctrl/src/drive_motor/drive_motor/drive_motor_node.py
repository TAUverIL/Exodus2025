...
class DriveMotorNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('motor_name', 'unnamed_drive')
        ...
        self.get_logger().info(f'{motor_name} Drive motor initialized.')

    def listener_callback(self, msg):
        self.get_logger().info(f'{self.motor_name} Deceived: {msg.data}')
        response = String()
