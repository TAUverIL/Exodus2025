...
#ifndef VEC_PURSUIT__VEC_PURSUIT_CONTROLLER_HPP_
#define VEC_PURSUIT__VEC_PURSUIT_CONTROLLER_HPP_
...
class VecPursuitController : public nav2_core::Controller
{
public:
  /**
   * @brief Constructor for vec_pursuit_controller::VecPursuitController
   */
  VecPursuitController() = default;

  /**
   * @brief Destrructor for vec_pursuit_controller::VecPursuitController
   */
  ~VecPursuitController() override = default;
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("VecPursuitController")};
...
#endif  // VEC_PURSUIT__VEC_PURSUIT_CONTROLLER_HPP_